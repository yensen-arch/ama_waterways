      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-viking-navy mb-4">
            AmaWaterways and Small Ship Travel - The Perfect Relationship
          </h2>
        ...
        <div className="mb-24">
          <div className="mb-12 flex justify-center border-2 border-viking-gold py-4">
            <img
              src="https://www.smallshiptravel.com/_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F6plxhipn%2Fproduction%2F0437eb6ce19ca36549e5c01e7886697d370f11f8-1280x401.png%3Fw%3D720&w=750&q=75"
              alt="AmaWaterways Logo"
              className="w-auto h-24 filter grayscale transition-all duration-300 hover:grayscale-0 hover:scale-110"
            />
          </div>
        ...
        <div>
          <div className="mb-12 flex justify-center border-2 border-viking-gold py-6">
            <img
